...
class CustomLoadingFlicker extends StatelessWidget {
  const CustomLoadingFlicker({
    super.key,
...
class _Flickr extends StatefulWidget {
  final Color leftDotColor;
  final Color rightDotColor;
  final double size;
...
class _FlickrState extends State<_Flickr> with SingleTickerProviderStateMixin {
